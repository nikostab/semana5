...
public class MascotasAdpter extends RecyclerView.Adapter<MascotasAdpter.MascotaViewHolder> {

    private ListaMascotas datos;
    private Activity activity;

    public MascotasAdpter(ListaMascotas datos, Activity activity) {
        this.datos = datos;
    ...
    public void onBindViewHolder(@NonNull final MascotaViewHolder holder, final int position) {
            holder.mascotaImage.setImageResource(datos.getListaMascotas().get(position).getImagen());
            holder.mascotaName.setText(datos.getListaMascotas().get(position).getName());
            holder.mascotaScore.setText(String.valueOf(datos.getListaMascotas().get(position).getRating()));
            holder.mascotaLikeBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(activity, "Te gusta " + datos.getListaMascotas().get(position).getName(), Toast.LENGTH_LONG).show();
                    holder.mascotaScore.setText(String.valueOf(datos.getListaMascotas().get(position).getRating()));
                }
            });
    }
    ...
    public int getItemCount() {
        return datos.getListaMascotas().size();
    }
